...
C     
C     Process: d u~ > n2 mu- WEIGHTED<=4 @1
C     *   Decay: n2 > mu- b~ t WEIGHTED<=4
C     Process: s c~ > n2 mu- WEIGHTED<=4 @1
C     *   Decay: n2 > mu- b~ t WEIGHTED<=4
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
     ...
     $    ABS(MDL_MN2*SMALL_WIDTH_TREATMENT)), MDL_WN2)
      ...
      CALL FFV4_3(W(1,4),W(1,5),GC_33,MDL_MWR, FK_MDL_WWR,W(1,6))
      CALL FFV4C1_2(W(1,3),W(1,6),GC_32,MDL_MN2, FK_MDL_WN2,W(1,5))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,6))
      CALL FFV4_3(W(1,1),W(1,2),GC_33,MDL_MWR, FK_MDL_WWR,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV4_0(W(1,5),W(1,6),W(1,3),GC_32,AMP(1))

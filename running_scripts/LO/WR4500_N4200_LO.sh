...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR4500_N4200 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR4500_N4200 pdmv
ls
mkdir result_WR4500_N4200
ls
mv *.tar.xz result_WR4500_N4200
mv *.log result_WR4500_N4200
cd result_WR4500_N4200
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

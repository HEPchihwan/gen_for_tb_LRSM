...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N900 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N900 pdmv
ls
mkdir result_WR6500_N900
ls
mv *.tar.xz result_WR6500_N900
mv *.log result_WR6500_N900
cd result_WR6500_N900
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

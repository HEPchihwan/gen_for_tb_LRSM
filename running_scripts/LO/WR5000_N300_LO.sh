...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5000_N300 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5000_N300 pdmv
ls
mkdir result_WR5000_N300
ls
mv *.tar.xz result_WR5000_N300
mv *.log result_WR5000_N300
cd result_WR5000_N300
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

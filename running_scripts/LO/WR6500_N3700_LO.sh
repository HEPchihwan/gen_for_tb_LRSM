...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N3700 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N3700 pdmv
ls
mkdir result_WR6500_N3700
ls
mv *.tar.xz result_WR6500_N3700
mv *.log result_WR6500_N3700
cd result_WR6500_N3700
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

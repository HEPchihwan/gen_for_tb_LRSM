...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5500_N4900 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5500_N4900 pdmv
ls
mkdir result_WR5500_N4900
ls
mv *.tar.xz result_WR5500_N4900
mv *.log result_WR5500_N4900
cd result_WR5500_N4900
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

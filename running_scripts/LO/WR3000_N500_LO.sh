...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR3000_N500 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR3000_N500 pdmv
ls
mkdir result_WR3000_N500
ls
mv *.tar.xz result_WR3000_N500
mv *.log result_WR3000_N500
cd result_WR3000_N500
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

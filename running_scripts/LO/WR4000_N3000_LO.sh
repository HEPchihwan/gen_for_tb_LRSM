...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR4000_N3000 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR4000_N3000 pdmv
ls
mkdir result_WR4000_N3000
ls
mv *.tar.xz result_WR4000_N3000
mv *.log result_WR4000_N3000
cd result_WR4000_N3000
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

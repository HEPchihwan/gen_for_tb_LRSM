...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N5200 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N5200 pdmv
ls
mkdir result_WR6500_N5200
ls
mv *.tar.xz result_WR6500_N5200
mv *.log result_WR6500_N5200
cd result_WR6500_N5200
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5000_N3800 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5000_N3800 pdmv
ls
mkdir result_WR5000_N3800
ls
mv *.tar.xz result_WR5000_N3800
mv *.log result_WR5000_N3800
cd result_WR5000_N3800
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

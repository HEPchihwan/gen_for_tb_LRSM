...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR2500_N2200 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR2500_N2200 pdmv
ls
mkdir result_WR2500_N2200
ls
mv *.tar.xz result_WR2500_N2200
mv *.log result_WR2500_N2200
cd result_WR2500_N2200
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5500_N3900 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5500_N3900 pdmv
ls
mkdir result_WR5500_N3900
ls
mv *.tar.xz result_WR5500_N3900
mv *.log result_WR5500_N3900
cd result_WR5500_N3900
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N5800 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N5800 pdmv
ls
mkdir result_WR6500_N5800
ls
mv *.tar.xz result_WR6500_N5800
mv *.log result_WR6500_N5800
cd result_WR6500_N5800
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

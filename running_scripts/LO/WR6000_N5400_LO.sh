...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6000_N5400 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6000_N5400 pdmv
ls
mkdir result_WR6000_N5400
ls
mv *.tar.xz result_WR6000_N5400
mv *.log result_WR6000_N5400
cd result_WR6000_N5400
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

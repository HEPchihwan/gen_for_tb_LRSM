...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5500_N3400 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5500_N3400 pdmv
ls
mkdir result_WR5500_N3400
ls
mv *.tar.xz result_WR5500_N3400
mv *.log result_WR5500_N3400
cd result_WR5500_N3400
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR3500_N1500 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR3500_N1500 pdmv
ls
mkdir result_WR3500_N1500
ls
mv *.tar.xz result_WR3500_N1500
mv *.log result_WR3500_N1500
cd result_WR3500_N1500
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR3000_N2400 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR3000_N2400 pdmv
ls
mkdir result_WR3000_N2400
ls
mv *.tar.xz result_WR3000_N2400
mv *.log result_WR3000_N2400
cd result_WR3000_N2400
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5500_N4400 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5500_N4400 pdmv
ls
mkdir result_WR5500_N4400
ls
mv *.tar.xz result_WR5500_N4400
mv *.log result_WR5500_N4400
cd result_WR5500_N4400
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR2000_N800 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR2000_N800 pdmv
ls
mkdir result_WR2000_N800
ls
mv *.tar.xz result_WR2000_N800
mv *.log result_WR2000_N800
cd result_WR2000_N800
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

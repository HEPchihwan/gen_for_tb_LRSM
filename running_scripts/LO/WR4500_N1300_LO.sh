...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR4500_N1300 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR4500_N1300 pdmv
ls
mkdir result_WR4500_N1300
ls
mv *.tar.xz result_WR4500_N1300
mv *.log result_WR4500_N1300
cd result_WR4500_N1300
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N700 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N700 pdmv
ls
mkdir result_WR6500_N700
ls
mv *.tar.xz result_WR6500_N700
mv *.log result_WR6500_N700
cd result_WR6500_N700
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR4500_N2000 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR4500_N2000 pdmv
ls
mkdir result_WR4500_N2000
ls
mv *.tar.xz result_WR4500_N2000
mv *.log result_WR4500_N2000
cd result_WR4500_N2000
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

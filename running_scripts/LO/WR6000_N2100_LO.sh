...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6000_N2100 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6000_N2100 pdmv
ls
mkdir result_WR6000_N2100
ls
mv *.tar.xz result_WR6000_N2100
mv *.log result_WR6000_N2100
cd result_WR6000_N2100
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

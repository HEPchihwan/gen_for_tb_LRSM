...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5000_N2600 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5000_N2600 pdmv
ls
mkdir result_WR5000_N2600
ls
mv *.tar.xz result_WR5000_N2600
mv *.log result_WR5000_N2600
cd result_WR5000_N2600
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

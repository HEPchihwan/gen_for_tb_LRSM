...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6000_N1400 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6000_N1400 pdmv
ls
mkdir result_WR6000_N1400
ls
mv *.tar.xz result_WR6000_N1400
mv *.log result_WR6000_N1400
cd result_WR6000_N1400
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

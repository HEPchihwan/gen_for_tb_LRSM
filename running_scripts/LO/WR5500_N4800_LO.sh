...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5500_N4800 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5500_N4800 pdmv
ls
mkdir result_WR5500_N4800
ls
mv *.tar.xz result_WR5500_N4800
mv *.log result_WR5500_N4800
cd result_WR5500_N4800
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

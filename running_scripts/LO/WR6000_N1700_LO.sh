...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6000_N1700 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6000_N1700 pdmv
ls
mkdir result_WR6000_N1700
ls
mv *.tar.xz result_WR6000_N1700
mv *.log result_WR6000_N1700
cd result_WR6000_N1700
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

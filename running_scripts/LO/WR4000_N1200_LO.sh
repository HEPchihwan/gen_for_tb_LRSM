...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR4000_N1200 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR4000_N1200 pdmv
ls
mkdir result_WR4000_N1200
ls
mv *.tar.xz result_WR4000_N1200
mv *.log result_WR4000_N1200
cd result_WR4000_N1200
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

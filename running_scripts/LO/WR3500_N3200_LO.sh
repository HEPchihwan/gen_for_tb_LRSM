...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR3500_N3200 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR3500_N3200 pdmv
ls
mkdir result_WR3500_N3200
ls
mv *.tar.xz result_WR3500_N3200
mv *.log result_WR3500_N3200
cd result_WR3500_N3200
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR4000_N200 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR4000_N200 pdmv
ls
mkdir result_WR4000_N200
ls
mv *.tar.xz result_WR4000_N200
mv *.log result_WR4000_N200
cd result_WR4000_N200
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

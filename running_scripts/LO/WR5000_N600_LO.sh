...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5000_N600 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5000_N600 pdmv
ls
mkdir result_WR5000_N600
ls
mv *.tar.xz result_WR5000_N600
mv *.log result_WR5000_N600
cd result_WR5000_N600
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

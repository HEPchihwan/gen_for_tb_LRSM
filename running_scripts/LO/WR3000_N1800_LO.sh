...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR3000_N1800 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR3000_N1800 pdmv
ls
mkdir result_WR3000_N1800
ls
mv *.tar.xz result_WR3000_N1800
mv *.log result_WR3000_N1800
cd result_WR3000_N1800
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

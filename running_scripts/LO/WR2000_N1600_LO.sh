...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR2000_N1600 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR2000_N1600 pdmv
ls
mkdir result_WR2000_N1600
ls
mv *.tar.xz result_WR2000_N1600
mv *.log result_WR2000_N1600
cd result_WR2000_N1600
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5000_N2300 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5000_N2300 pdmv
ls
mkdir result_WR5000_N2300
ls
mv *.tar.xz result_WR5000_N2300
mv *.log result_WR5000_N2300
cd result_WR5000_N2300
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

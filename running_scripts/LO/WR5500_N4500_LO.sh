...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5500_N4500 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5500_N4500 pdmv
ls
mkdir result_WR5500_N4500
ls
mv *.tar.xz result_WR5500_N4500
mv *.log result_WR5500_N4500
cd result_WR5500_N4500
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

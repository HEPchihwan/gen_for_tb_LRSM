...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5500_N3100 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5500_N3100 pdmv
ls
mkdir result_WR5500_N3100
ls
mv *.tar.xz result_WR5500_N3100
mv *.log result_WR5500_N3100
cd result_WR5500_N3100
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

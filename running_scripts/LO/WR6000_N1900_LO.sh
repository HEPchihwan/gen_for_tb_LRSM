...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6000_N1900 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6000_N1900 pdmv
ls
mkdir result_WR6000_N1900
ls
mv *.tar.xz result_WR6000_N1900
mv *.log result_WR6000_N1900
cd result_WR6000_N1900
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

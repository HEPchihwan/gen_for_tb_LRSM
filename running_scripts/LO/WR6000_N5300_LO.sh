...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6000_N5300 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6000_N5300 pdmv
ls
mkdir result_WR6000_N5300
ls
mv *.tar.xz result_WR6000_N5300
mv *.log result_WR6000_N5300
cd result_WR6000_N5300
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR4500_N400 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR4500_N400 pdmv
ls
mkdir result_WR4500_N400
ls
mv *.tar.xz result_WR4500_N400
mv *.log result_WR4500_N400
cd result_WR4500_N400
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

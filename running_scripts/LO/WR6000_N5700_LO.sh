...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6000_N5700 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6000_N5700 pdmv
ls
mkdir result_WR6000_N5700
ls
mv *.tar.xz result_WR6000_N5700
mv *.log result_WR6000_N5700
cd result_WR6000_N5700
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

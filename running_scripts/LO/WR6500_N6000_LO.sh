...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N6000 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N6000 pdmv
ls
mkdir result_WR6500_N6000
ls
mv *.tar.xz result_WR6500_N6000
mv *.log result_WR6500_N6000
cd result_WR6500_N6000
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6000_N4600 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6000_N4600 pdmv
ls
mkdir result_WR6000_N4600
ls
mv *.tar.xz result_WR6000_N4600
mv *.log result_WR6000_N4600
cd result_WR6000_N4600
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

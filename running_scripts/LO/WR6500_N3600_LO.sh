...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N3600 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N3600 pdmv
ls
mkdir result_WR6500_N3600
ls
mv *.tar.xz result_WR6500_N3600
mv *.log result_WR6500_N3600
cd result_WR6500_N3600
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

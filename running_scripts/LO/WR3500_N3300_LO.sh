...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR3500_N3300 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR3500_N3300 pdmv
ls
mkdir result_WR3500_N3300
ls
mv *.tar.xz result_WR3500_N3300
mv *.log result_WR3500_N3300
cd result_WR3500_N3300
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N2800 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N2800 pdmv
ls
mkdir result_WR6500_N2800
ls
mv *.tar.xz result_WR6500_N2800
mv *.log result_WR6500_N2800
cd result_WR6500_N2800
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

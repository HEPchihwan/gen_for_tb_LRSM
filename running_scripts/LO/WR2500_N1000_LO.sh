...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR2500_N1000 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR2500_N1000 pdmv
ls
mkdir result_WR2500_N1000
ls
mv *.tar.xz result_WR2500_N1000
mv *.log result_WR2500_N1000
cd result_WR2500_N1000
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR5500_N2700 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR5500_N2700 pdmv
ls
mkdir result_WR5500_N2700
ls
mv *.tar.xz result_WR5500_N2700
mv *.log result_WR5500_N2700
cd result_WR5500_N2700
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

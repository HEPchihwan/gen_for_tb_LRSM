...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR4000_N3500 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR4000_N3500 pdmv
ls
mkdir result_WR4000_N3500
ls
mv *.tar.xz result_WR4000_N3500
mv *.log result_WR4000_N3500
cd result_WR4000_N3500
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

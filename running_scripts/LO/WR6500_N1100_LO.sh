...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N1100 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N1100 pdmv
ls
mkdir result_WR6500_N1100
ls
mv *.tar.xz result_WR6500_N1100
mv *.log result_WR6500_N1100
cd result_WR6500_N1100
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"

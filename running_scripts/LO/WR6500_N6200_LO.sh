...
ls
./gridpack_generation.sh WRtoNLtoLLJJtb_WR6500_N6200 cards/0tb_channel/LO/WRtoNLtoLLJJtb_WR6500_N6200 pdmv
ls
mkdir result_WR6500_N6200
ls
mv *.tar.xz result_WR6500_N6200
mv *.log result_WR6500_N6200
cd result_WR6500_N6200
tar -xavf *.tar.xz
FILE="runcmsgrid.sh"
